...
assert('noon uses kloofendal (rim clouds)', /t: hour\(12\), url: DAY_SKY_HDR\.kloofendal/.test(src))
...
assert('noon is photographed day (night: 0)', /t: hour\(12\), url: DAY_SKY_HDR\.kloofendal, gain: 1, night: 0/.test(src))
